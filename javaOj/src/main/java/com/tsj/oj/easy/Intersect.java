...
public class Intersect{
    ...
    public static void main(String[] args){
        ...
        // List<User> cc = new ArrayList<User>(){{add(new User(1,"2")); }};
        // List<User> nn = new ArrayList<User>(){{add(new User(2,"2")); }};
        // List<User> fl = cc.stream().filter(user -> !nn.contains(user)).collect(Collectors.toList());
